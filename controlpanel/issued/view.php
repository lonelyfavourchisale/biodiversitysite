...
<body>
	<h1 class="text-capitalize text-center font-weight-bold">iterms issued details</h1>
...
<table class="table" border="2px" style="width: 99%;margin-left: 5px;">
						<?php 
$select="SELECT * FROM issue_item  ORDER BY id desc";
...
?>
					...
					<tr style="height: 60px">
						...
						<td class='text-capitalize'><?php echo $data['location']; ?></td>
