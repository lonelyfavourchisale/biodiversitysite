...
<div class="row no-gutters">
  ...
  <li class="nav-item">
    ...
    <ul style="display:none" class="itemmenu">
    	<li class="list-unstyled text-capitalize text-white adduser"><span class="fa fa-plus-square mr-1"></span><a href="items/view.php" class="text-white text-capitalize">uploaded items</a></li>
