  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <iframe src="profile/update.php" width="100%" height="500px" style="border:none;height: 400px"></iframe>
      </div>
...
<div class="modal status" id="my" style="margin-top: 20%">
	...
	<div class="col-12 col-sm-12 col-lg-10 col-xl-10 " style="background-color: ">
		...
		<div class="statistics justify-content-center">
			...
			<div class="item bg-secondary">
				<h2 class="text-white"><?php echo mysqli_num_rows($sqlquery); ?></h2>
  ...
  <!--div for displaying borrowing form-->
	  <div class="borrow ">
       <div class="justify-content-center ">
        <div class="description " style="width: 500px;max-width: 90%">
				...
				<p class="border-bottom">borrow an item by filling the form given,you will be given the barcode number which is suppose to be kept so that you can have access to ordered item</p>
			</div>
	  ...
	  <div class="contact ">
       <div class="justify-content-center">
        <div class="left" style="width: 500px;max-width: 90%">
				<h1 style="font-size:20px;text-transform: capitalize;font-weight: 600;"><span class=" 	fa fa-user-circle-o mr-1"></span>need help??</h1>
				<p class="border-bottom">enter your location and the message you want to ask about using the form given by filling all the fields</p>
			</div>
			 <div style="width: 500px;">
				<div class="card-body">
					<iframe src="contacts/index.php" style="width: 100%;border:none;height: 600px"></iframe>
				</div>
			</div>
    ...
    <div class="modal helpdiv" id="myhelp">
      ...
      <div class="feedback" style="width:700px;max-width: 90%">
      ...
      <?php 
$select="SELECT * FROM issue_item limit 8";
	  ...
	  <div class="resetdiv">
       <div class="justify-content-center ">
        <div class="left " style="width: 400px;max-width: 90%">
				<h1 style="font-size:20px;text-transform: capitalize;font-weight: 600;"><span class=" 	fa fa-user-circle-o mr-1"></span>reset your password</h1>
				<p class="border-bottom">reset your password for security issue periodically using the form given by fillinf all the fields</p>
			</div>
...
<footer class="card border-top " id="footer">
	<h5 class="text-warning" style="text-align: right;margin-right: 20px;margin-top: 10px;font-size: 10px">@must biodiversity equpiment management system 2022</h5>
</footer>
