...
$fetch=mysqli_fetch_assoc($query);
	 ...
	 ?>
<img src="../../controlpanel/uploads/<?php echo $fetch['profile']; ?>" width="100px">
...
// if everything is ok, try to upload file
 ...
 echo "";
   ...
   if ($query) {
   echo "<p class='alert alert-success'>profile updated successfully,refresh the page for changes</p>";
